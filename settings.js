...
global.owner = process.env.OWNER_NUMBER  || '917047294917' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=DBUhRJ7Q#FL3QrN9wXTWpeHUyIymeivDbKlHeTCjvtCHQXIIkKk4' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "917047294917" : process.env.MODERATORS ,    
